...
public abstract class DictionaryDrawer<TK, TV> : PropertyDrawer
{
    ...
    private static T DoField<T>(Rect rect, Type type, T value)
    {
        ...
        if (typeof(DataRow.Attribute).IsAssignableFrom(type))
        {
            DataRow.Attribute attr = (DataRow.Attribute)(object)value;
            attr.type = (DataRow.Attribute.Type)EditorGUI.EnumPopup(rect, attr.type);
            return value;
        }
